...
export const metadata = buildMetadata({
  title: 'Blog',
  description: 'Guides, tips, and stories on downloading video the right way.',
  path: '/blog',
});
  ...
  return (
    <Container className="py-24 max-w-6xl">
      <div className="max-w-2xl mb-14">
        <p className="text-sm font-semibold uppercase tracking-wider text-gradient inline-block mb-3">The Blog</p>
        <h1 className="text-4xl md:text-5xl font-bold tracking-tight leading-[1.05]">
          Guides, Tips &amp; Stories.
        </h1>
        <p className="mt-4 text-text-muted leading-relaxed">
          Everything we&apos;ve learned about downloading and repurposing video the right way.
        </p>
      </div>
