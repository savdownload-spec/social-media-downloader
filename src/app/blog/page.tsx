      ...
      <section className="relative overflow-hidden border-b border-border bg-gradient-mesh">
        ...
        <Container className="relative max-w-6xl py-16 md:py-20">
          <div className="max-w-3xl">
            <p className="text-sm font-semibold uppercase tracking-[0.2em] text-primary">The SavDown blog</p>
            <h1 className="mt-4 font-display text-4xl font-semibold leading-[1.04] tracking-tight text-text md:text-6xl">
              Guides for saving, creating, and sharing content responsibly.
            </h1>
            <p className="mt-5 max-w-2xl text-base leading-7 text-text-muted md:text-lg">
              Practical downloader guides, creator workflows, format tips, and clear answers for everyday media tasks.
            </p>
          </div>
        </Container>
      </section>
