...
function LoginClient() {
  ...
  if (status === 'loading' || (status === 'authenticated' && session?.user)) {
    return <Section variant="white" className="py-16"><Container><div className="mx-auto max-w-md rounded-[28px] border border-border/70 bg-white/90 px-6 py-16 text-center shadow-soft"><div className="mx-auto mb-5 flex h-12 w-12 items-center justify-center rounded-2xl bg-primary-light text-primary"><LockKeyhole className="h-5 w-5" /></div><p className="text-sm font-semibold text-text">Checking your account</p><p className="mt-2 text-sm text-text-muted">Just a moment while we prepare your account.</p></div></Container></Section>;
  }
  ...
  return (
    <Section variant="white" className="relative overflow-hidden bg-[#fcfbff] py-12 text-[#0f0b1e] md:py-20">
