...
export default function AdminSupportPage() { return <AdminPage><PageHeader title="Support" description="Manage customer conversations, assignments, and resolution." /><AdminSupportInbox /></AdminPage>; }
