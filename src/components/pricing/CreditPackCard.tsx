...
export function CreditPackCard({ pack }: { pack: PackView }) {
  ...
  const cta = highlighted
    ...
    : 'mt-6 flex items-center justify-center gap-2 w-full py-3 rounded-2xl text-sm font-semibold bg-white dark:bg-card text-text border border-border hover:border-primary/40 hover:bg-primary-light transition-all active:scale-[0.98]';
